    ...
    <div className="relative">
      ...
      <div className="flex items-center space-x-2">
        <button
          ...
          className="px-3 py-1.5 bg-blue-600 text-white rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:ring-offset-2 focus:ring-offset-slate-800 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 text-xs font-medium shadow-md shadow-blue-600/25"
        >
